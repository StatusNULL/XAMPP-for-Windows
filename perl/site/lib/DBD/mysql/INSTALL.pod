...
mailing list B<msql-mysql-modules@lists.mysql.com>. See
...
create a script called C<mysql_config>. This is described in
more details later. L</Configuration>.
...
L</C Compiler flags>. L</Linker flags>.
...
of the mailing list B<msql-mysql-modules@lists.mysql.com>. See
