...
include_once("M:\xampp\php\pear\data/PhpDocumentor/docbuilder/includes/utilities.php" );

// find the .ini directory by parsing phpDocumentor.ini and extracting _phpDocumentor_options[userdir]
$ini = phpDocumentor_parse_ini_file('M:\xampp\php\pear\data/PhpDocumentor/phpDocumentor.ini', true);
if (isset($ini['_phpDocumentor_options']['userdir'])) {
	$configdir = $ini['_phpDocumentor_options']['userdir'];
} else {
	$configdir =  'M:\xampp\php\pear\data/PhpDocumentor/user';
}
...
$path = 'M:\xampp\php\pear\data/PhpDocumentor/docbuilder/images/';
if ($dir = opendir($path)) {
