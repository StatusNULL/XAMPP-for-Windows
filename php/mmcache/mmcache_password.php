...
function main_cli() {
  echo "Changing password for Turck MMCache Web Interface (mmcache.php)\n\n";
  ...
  echo "\nAdd the following lines into your php.ini and restart HTTPD\n\n".
       "mmcache.admin.name=\"$name\"\n".
       "mmcache.admin.password=\"$password\"\n";
}
...
function main_web() {
  ...
  if (isset($_POST["submit"])) {
    ...
    if (empty($admin_name)) {
      ...
      echo "<html><head><title>Changing password for Turck MMCache Web Interface (mmcache.php)</title></head>".
           "<body><h1 align=\"center\">Changing password for Turck MMCache Web Interface (mmcache.php)</h1>".
           "Add the following lines into your php.ini and restart HTTPD<br><pre><b>".
           "mmcache.admin.name=\"$admin_name\"\n".
           "mmcache.admin.password=\"$password\"\n</b></pre></body></html>";
      return;
    }
  }
