...
$TEXT['security-text2']="Los puntos marcados en verde estan seguros; los puntos en rojo son definitivamente inseguros y en los amarillos no se pudo comprobar la seguridad (por ejemplo porque el programa a comprobar no estaba en marcha).<p>Para solucionar estos agujeros en la seguridad llame simplemente al siguiente comando:<p>=> <A HREF=xamppsecurity.php><B>http://localhost/xampp/xamppsecurity.php</B></A> <= &nbsp;&nbsp;[allowed only for localhost]<p>De esta manera se inicia un programa interactivo, que cerrará todos estos agujeros de seguridad.";
...
$TEXT['cds-head']="Administración del CD (Ejemplo de una clase PHP+MySQL+PDF)";
...
$TEXT['cds-text2']="<b>Nuevo desde 0.9.6:</b> Salida de los CDs elegidos cómo <a href='$PHP_SELF?action=getpdf'>Documento PDF</a>.";
...
$TEXT['flash-text1']="Lamentablemente el proyecto MING para Windows no se siguió desarrollando y por esto está incompleto<br>Compare por favor<a class=blue target=extern href=\"http://ming.sourceforge.net/install.html/\">Ming - and SWF output library and PHP module</a>";
$TEXT['flash-ok']="OK";
