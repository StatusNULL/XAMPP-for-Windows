...
$TEXT['security-text2']="Le voci contrassegnate in verde sono sicure; quelle in rosso sono assolutamente non sicure e quelle in giallo non sono state valutate (ad esempio perchè il software di verifica non è in esecuzione).<p><p>To fix the problems for mysql, phpmyadmin and the xampp directory simply use</B><p>=> <A HREF=xamppsecurity.php><B>http://localhost/security/xamppsecurity.php</B></A> <= &nbsp;&nbsp;[allowed only for localhost]";
...
$TEXT['cds-head']="Collezione CD (Esempio della classe PHP+MySQL+PDF)";

$TEXT['cds-text1']="Un programma CD molto semplice.";

$TEXT['cds-text2']="Lista del CD in <a href='$PHP_SELF?action=getpdf'>PDF</a>.";
