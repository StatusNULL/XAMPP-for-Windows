...
$TEXT['status-text1']="Ta strona pokazuje co obecnie dziala a co nie.";
$TEXT['status-text2']="Niektóre zmiany w konfiguracji mog? dawac falszywy negatywny efekt. Przy SSL (https://localhost) raporty te nie dzialaj?!";
...
$TEXT['status-ok']="WLzCZONE";
$TEXT['status-nok']="WYLzCZONE";
...
$TEXT['security-head']="Bezpieczenstwo XAMPPa";
$TEXT['security-text1']="Ta strona informuje o poziomie bezpieczenstwa XAMPPa (prosze czytac tekst pod tabel?) <I>Sorry, no polish translation for this section available, so switching to english.</I>";
...
$TEXT['start-text1']="Mozesz juz korzystac z Apache i reszty jego kumpli. Zanim to zrobisz mozesz sprawdzic co dziala klikaj?c w link <B>Status</b> obok.";

$TEXT['start-text2']="Uwaga, XAMPP w wersji 1.4 jest przystosowany do zarz?dzania pakietami. XAMPP posiada pakiety: <UL><LI>XAMPP pakiet bazowy</LI><LI>XAMPP Perl</LI><LI>XAMPP Python<LI></LI>XAMPP Utility addon (wiecej narzedzi, lecz nieaktywnych)</LI><LI>XAMPP Server addon (wiecej opcji serwerowych, lecz nieaktywnych)</LI><LI>XAMPP Inne dodatki (nieaktywne)</LI></UL>";

$TEXT['start-text3']="Dla normalnej inicjalizacji dodatku odpal 1 raz na 1 dodatek plik \"setup_xampp.bat\". Dla dodatków instalacyjnych musisz miec instalacyjn? wersje XAMPPa! W innych przypadkach XAMPP zip moze byc.";

$TEXT['start-text4']="Dla wsparcia OpenSSL prosze uzywac testu certyfikatu z <a href='https://127.0.0.1' target='_top'>https://127.0.0.1</a> lub <a href='https://localhost' target='_top'>https://localhost</a>";

$TEXT['start-text5']="I najwazniejsze - podziekowania dla Carsten, Nemesis, KriS, Boppy, Pc-Dummy i wielu innym, którzy pomagaj? rozwijac XAMPPa!<BR><BR>Polskie miniwsparcie w <a href=\"http://www.cms.rk.edu.pl\" target=\"_blank\">Bibliotece CMS Riklaunima</a>.";
...
$TEXT['manuals-text1']="XAMPP l?czy ze sob? wiele programów. Oto ich lista i odno?niki do dokumentacji.";
...
$TEXT['manuals-text2']="Oto mala lista tutoriali Apache i strona Apache Friends:";
...
$TEXT['components-text1']="XAMPP l?czy ze sob? wiele programów, oto ich lista.";
...
$TEXT['cds-head']="Kolekcja plyt CD (Przyklad klasy PHP+MySQL+PDF)";

$TEXT['cds-text1']="Prosty program CD.";

$TEXT['cds-text2']="Lista CD jako <a href='$PHP_SELF?action=getpdf'>Dokument PDF</a>.";

$TEXT['cds-error']="Nie mozna pol?czyc sie z baz? danych!<br>Czy MySQL chodzi, czy nie zmienile? hasla?";
$TEXT['cds-head1']="Moje CDs";
$TEXT['cds-attrib1']="Wykonawca";
$TEXT['cds-attrib2']="Tytul";
...
$TEXT['bio-head']="Biorytmy (przyklad zastosowania PHP+GD)";

$TEXT['bio-by']="przez";
$TEXT['bio-ask']="Wprowad? date urodzenia";
$TEXT['bio-ok']="OK";
$TEXT['bio-error1']="Data";
$TEXT['bio-error2']="jest bledna";
...
$TEXT['iart-head']="Blyskawiczna Grafika (Zastosowanie PHP+GD+FreeType)";
...
$TEXT['flash-text1']="MING dla Windows32 nie jest jeszcze gotowy.<br>Szczególy: <a class=blue target=extern href=\"http://www.opaque.net/wiki/index.php?Ming\">Ming - an SWF output library and PHP module</a>";
$TEXT['flash-ok']="OK";
...
$TEXT['about-subhead1']="Cele i zalozenia";

$TEXT['about-subhead2']="Szata graficzna";

$TEXT['about-subhead3']="Wspólpraca";
...
$TEXT['srccode-in']="Kod ?ródlowy tutaj";

// ---------------------------------------------------------------------
// MERCURY
// ---------------------------------------------------------------------

$TEXT['mail-head']="Wysylanie maili za pomoc? Mercury Mail na serwerach SMTP i POP3";
...
$TEXT['mail-message']="Wiadomo?c:";
$TEXT['mail-sendnow']="Wiadomo?c jest wysylana ...";
$TEXT['mail-sendok']="Wiadomo?c wyslana pomy?lnie!";
$TEXT['mail-sendnotok']="Bl?d! Nie udalo sie wyslac poprawnie wiadomo?c!";
$TEXT['mail-help1']="Notki:<br><br>";
$TEXT['mail-help2']="<UL>
<LI>Mercury potrzebuje zewnetrznego pol?czenia przy starcie;</LI>
<LI>przy starcie Mercury definiuje Domain Name Service (DNS) automatycznie, jako nazwe serwera twojego dostawcy;</LI>
<LI>Dla uzytkowników gateway servers: Prosze ustawic DNS poprzez TCP/IP (poprzez InterNic z IP 198.41.0.4);</LI>
<LI>Plik konfiguracyjny Mercury to MERCURY.INI;</LI>
<LI>dla testów mozesz wyslac email do postmaster@localhost lub admin@localhost i poszukac tych wiadomo?ci w katalogach: xampp.../mailserver/MAIL/postmaster lub (...)/admin;</LI>
<LI>jeden testowy uzytkownik \"newuser\" (newuser@localhost) z haslem = wampp;</LI>
...
$TEXT['filezilla-install2']="W glównym katalogu XAMPPa uruchom \"filezilla_setup.bat\" by skonfigurowac serwer. Uwaga: Dla Windows NT, 2000 i XP Professional, FileZilla musi zostac zainstalowana jako service.";
$TEXT['filezilla-install3']="Konfigurowanie \"FileZilla FTP\". W tym celu uzyj interfejsu FileZilla \"FileZilla Server Interface.exe\". W przykladzie ustawieni s? dwaj uzytkownicy:<br><br>
A: Domy?lny uzytkownik \"newuser\", haslo \"wampp\". Glówny katalog xampp\htdocs.<br> 
B: Anonimowy uzytkownik \"anonymous\", bez hasla. Glówny katalog xampp\anonymous.<br><br>
Domy?lnym interfejsem jest adres loopback - 127.0.0.1.";
$TEXT['filezilla-install4']="Serwer FTP jest wyl?czany za pomoc? \"FileZillaFTP_stop.bat\". Dla FileZilla jako service uzyj \"FileZillaServer.exe\" bezpo?rednio. Wtedy mozesz skonfigurowac wszystkie opcje startowe.";
...
$TEXT['pear-cell']="Warto?c komórki";
...
$TEXT['ADOdb-head']="ADOdb - Dostep do baz danych (PHP)";
$TEXT['ADOdb-text']="ADOdb wspiera MySQL, PostgreSQL, Interbase, Firebird, Informix, Oracle, MS SQL 7, Foxpro, Access, ADO, Sybase, FrontBase, DB2, SAP DB, SQLite i pochodne ODBC. Obsluga Sybase, Informix, FrontBase i PostgreSQL zostala zaimplementowana przez fanów projektu. Znajdziesz je w \(mini)xampp\php\pear\adodb.";
$TEXT['ADOdb-example']="Przyklad:";
$TEXT['ADOdb-dbserver']="Server bay danych (MySQL, Oracle ..?)";
$TEXT['ADOdb-host']="Host (nazwa lub IP)";
$TEXT['ADOdb-user']="Uzytkownik ";
$TEXT['ADOdb-password']="Haslo";
...
$TEXT['info-examples']="Przyklady";
$TEXT['info-conf']="Pliki konfiguracyjne";
$TEXT['info-requires']="Wymaga";
$TEXT['info-alternative']="Alternatywa";
$TEXT['info-tomcatwarn']="Uwaga, Tomcat nie dziala na porcie 8080.";
$TEXT['info-tomcatok']="OK! Tomcat dziala na porcie 8080.";
$TEXT['info-tryjava']="Przyklad Javy (JSP) z Apache MOD_JK.";
$TEXT['info-nococoon']="Uwaga, Tomcat nie dziala na porcie 8080, nie mozna zainstalowac cocoon!";
$TEXT['info-okcocoon']="Tomcat dziala na porcie 8080! By zainstalowac \"Cocoon\" kliknij tutaj ...";
